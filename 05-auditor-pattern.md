...
### The Post-Sleep Disconnect
After a laptop sleep/wake cycle, some agents restart but A2A messaging doesn't fully reconnect. Messages sent during the wake-up window silently fail to deliver.

**Fix:** Auditor runs a post-wake audit cycle, checks delivery receipts for recent messages, and re-sends anything that didn't land.
